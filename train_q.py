...
def train(system: System):
    ...
    path = os.path.join("models", system.name, system.add_path, "q_model_state_dict.pth")
    os.makedirs(os.path.dirname(path), exist_ok=True)
    torch.save(net.state_dict(), path)

    joblib.dump(scaler_in, os.path.join("models", system.name, system.add_path, 'q_scaler_in.pkl'))
    joblib.dump(scaler_lab, os.path.join("models", system.name, system.add_path, 'q_scaler_lab.pkl'))
    # IPS()
